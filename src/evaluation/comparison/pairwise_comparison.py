...
class Comparison:
    ...
    def load_coco_data(self, category : Union[str, int], first = False):
...
if __name__ == '__main__':
    ...
    comparison.load_coco_data(2, False)
    # comparison.load_json_data('/home.stud/kuntluka/MT/notebooks/ensembled_test.json')
    print(comparison.precision_evaluate(criterion='centroids'))
