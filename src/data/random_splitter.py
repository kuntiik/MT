...
from src.utils.ice_utils import np_local_seed


class DataSplitter(ABC):
    """Base class for all samples splitters."""
...
class RandomSplitter(DataSplitter):
    ...
    # Examples
        ...
        Split samples into three random groups.
...
class FixedSplitter(DataSplitter):
    ...
    # Examples
        ...
        Split samples into three pre-defined groups.
        ```python
        idmap = IDMap(["file1", "file2", "file3", "file4"])
